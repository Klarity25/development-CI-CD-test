...
//     >
//       <path
//         d="M2 11.9556C2 8.47078 2 6.7284 2.67818 5.39739C3.27473 4.22661 4.22661 3.27473 5.39739 2.67818C6.7284 2 8.47078 2 11.9556 2H20.0444C23.5292 2 25.2716 2 26.6026 2.67818 2.7953 17.7734 5.22661 8.7253 27.3218 23.596C29 6 30 29 26.6028 25 27.7734 24 28 28.3218C25 23 23 20 29 20.0444 23 23.5292C30 23.5296 25.2716 23.2718 25.3218 26.6026C29.7253 26.6028 27.7734 29 28.7253 26.6026 25.2716 27 29.3218 25 26 25.2716 23.5292 2C20.9556V20.0444C30 20.0444 30 25.2716 29 26.6026C28.7253 27.7734 27.7734 28.7253 26.6026 29.3218C25.2716 30 23.5292 30 20.0444 30H11.9556C8.47078 30 6.7284 30 5.39739 29.3218C4.22661 28.7253 3.27473 27.7734 2.67818 26.6026C2 25.2716 2 23.5292 2 20.0444V11.9556Z"
//         fill="white"
//       />
//       <path
...
//   if (!["Admin", "Super Admin"].includes(user?.role?.roleName)) {
//     return (
//       <div className="flex items-center justify-center min-h-screen">
//         <div className="text-center">
...
//         <motion.aside
//           className="bg-white/95 backdrop-blur-xl border-r border-slate-200/60 shadow-xl flex flex-col fixed top-0 left-0 h-screen z-40"
//           initial={{ width: "80px" }}
...
//         >
//           {/* Header Section */}
//           <div className="p-6 border-b border-slate-200/60 mt-17">
//             {isSidebarCollapsed ? (
...
//                           }}
//                           className="h-8 w-8 rounded-xl transition-all duration-200 cursor-pointer hover:bg-slate-100 text-slate-500 relative"
//                         >
...
//                                   }
//                                   className={`flex items-center justify-center cursor-pointer gap-2 p-2 rounded-lg text-sm font-medium transition-all duration-200 ${
...
//                             className="ml-auto px-2 py-1 bg-orange-100 text-orange-600 text-xs font-medium rounded-full"
//                           >
//                             Soon
//                           </motion.div>
//                         )}
...
//                       <Button
//                         variant="outline"
//                         className="flex-1 border-2 border-slate-200 text-slate-700 hover:bg-slate-50 cursor-pointer rounded-xl"
//                         onClick={() => setShowDisableConfirm(false)}
//                       >
//                         Keep Enabled
//                       </Button>
//                       <Button
//                         className="flex-1 bg-red-500 hover:bg-red-600 text-white cursor-pointer rounded-xl"
...
//                       ) : (
//                         <div className="flex flex-col items-center justify-center py-6 text-center">
//                           <div className="bg-blue-100 p-4 rounded-full mb-1">
