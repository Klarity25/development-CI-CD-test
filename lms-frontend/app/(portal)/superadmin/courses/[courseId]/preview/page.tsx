...
//     return (
//       <div className="fixed inset-0 bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 flex items-center justify-center overflow-hidden">
//         <motion.div className="relative z-10 flex flex-col items-center space-y-6">
//           <div className="relative">
//             <motion.div
//               className="w-20 h-20 border-3 border-purple-200/50 rounded-full"
//               animate={{ rotate: 360 }}
//               transition={{
//                 duration: 2,
...
//             />
//             <motion.div
//               className="absolute top-1 left-1 w-18 h-18 border-3 border-blue-300/60 rounded-full border-t-transparent"
//               animate={{ rotate: -360 }}
//               transition={{
//                 duration: 1.5,
//                 repeat: Number.POSITIVE_INFINITY,
...
//             >
//               <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center shadow-xl">
...
//   if (error) {
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-red-50 via-pink-50 to-orange-50 p-4 md:p-6 mt-10">
...
//               className="mb-6 border-red-200 text-red-700 hover:bg-red-50 rounded-xl px-6 py-2 font-medium shadow-lg backdrop-blur-sm bg-white/80 transition-all duration-300"
//             >
//               ← Back to Courses
//             </Button>

//             <div className="bg-white/80 backdrop-blur-xl border border-red-100 p-8 rounded-2xl shadow-xl">
...
//                 className="mt-4 bg-gradient-to-r from-red-500 to-pink-500 hover:from-red-600 hover:to-pink-600 text-white px-6 py-2 rounded-lg font-medium shadow-lg"
//               >
//                 Try Again
//               </Button>
//             </div>
...
//   if (!course) {
//     return (
//       <div className="min-h-screen bg-gradient-to-br from-gray-50 via-slate-50 to-zinc-50 p-4 md:p-6 mt-10">
//         <div className="max-w-2xl mx-auto">
//           <motion.div
//             initial={{ opacity: 0, y: -30 }}
//             animate={{ opacity: 1, y: 0 }}
...
//               variant="outline"
//               onClick={() => router.push("/superadmin/courses")}
//               className="mb-6 border-gray-200 text-gray-700 hover:bg-gray-50 rounded-xl px-6 py-2 font-medium shadow-lg backdrop-blur-sm bg-white/80 transition-all duration-300"
//             >
//               ← Back to Courses
//             </Button>

//             <div className="bg-white/80 backdrop-blur-xl border border-gray-100 p-8 rounded-2xl shadow-xl">
...
//   return (
//     <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50 p-4 md:p-6 mt-10 relative overflow-hidden">
//       {/* Compact animated background */}
//       <div className="absolute inset-0 overflow-hidden opacity-30">
//         <motion.div
//           className="absolute -top-20 -right-20 w-40 h-40 bg-purple-200/40 rounded-full blur-2xl"
//           animate={{ scale: [1, 1.2, 1], rotate: [0, 180, 360] }}
//           transition={{ duration: 15, repeat: Number.POSITIVE_INFINITY }}
//         />
//         <motion.div
//           className="absolute -bottom-20 -left-20 w-48 h-48 bg-blue-200/40 rounded-full blur-2xl"
...
//             variant="outline"
//             onClick={() => router.push("/superadmin/courses")}
//             className="border-indigo-200 text-indigo-700 hover:bg-indigo-50 rounded-xl px-6 py-2 font-medium shadow-lg backdrop-blur-xl bg-white/80 transition-all duration-300"
//           >
//             ← Back to Courses
//           </Button>
//         </motion.div>
...
//           className="relative bg-white/70 backdrop-blur-2xl rounded-2xl p-6 md:p-8 shadow-2xl border border-white/50 overflow-hidden"
//         >
...
//               <div className="relative bg-gradient-to-r from-purple-500 via-blue-500 to-pink-500 text-white px-8 py-4 rounded-2xl shadow-xl inline-block">
...
//                   <Badge className="bg-gradient-to-r from-blue-100 to-cyan-100 text-blue-700 px-4 py-2 rounded-xl text-sm font-medium border border-blue-200">
//                     <Target className="w-4 h-4 mr-1" />
//                     {course.targetAudience}
//                   </Badge>
//                 )}
//                 {course.duration && (
//                   <Badge className="bg-gradient-to-r from-emerald-100 to-green-100 text-emerald-700 px-4 py-2 rounded-xl text-sm font-medium border border-emerald-200">
//                     <Clock className="w-4 h-4 mr-1" />
//                     {course.duration}
//                   </Badge>
//                 )}
//                 <Badge className="bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 px-4 py-2 rounded-xl text-sm font-medium border border-purple-200">
//                   <BookOpen className="w-4 h-4 mr-1" />
//                   {course.chapters?.length || 0} Chapters
//                 </Badge>
//                 <Badge className="bg-gradient-to-r from-yellow-100 to-orange-100 text-yellow-700 px-4 py-2 rounded-xl text-sm font-medium border border-yellow-200">
...
//                     </span>
//                   </h1>
//                   <div className="w-24 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-full mx-auto" />
//                 </div>
...
//                           }}
//                           className="bg-white/80 backdrop-blur-xl rounded-2xl p-6 shadow-xl border border-white/60 hover:border-indigo-200 transition-all duration-300"
//                         >
//                           <div className="flex items-center space-x-4 mb-4">
//                             <div className="w-10 h-10 bg-gradient-to-r from-purple-500 to-pink-500 rounded-xl flex items-center justify-center text-white font-bold text-sm shadow-lg">
//                               {chapterIndex + 1}
//                             </div>
//                             <div>
...
//                                 >
//                                   <div
//                                     className="bg-white/60 backdrop-blur-xl p-4 rounded-xl shadow-lg border border-white/40 cursor-pointer transition-all duration-300 hover:bg-white/80 hover:border-indigo-200"
//                                     onClick={() =>
...
//                                         </div>
//                                       </div>
//                                       <button className="w-8 h-8 bg-gradient-to-r from-purple-100 to-pink-100 rounded-lg flex items-center justify-center text-gray-700 border border-purple-200">
//                                         {openLessons[
...
//                                                         >
//                                                           <div className="w-2 h-2 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-1.5 flex-shrink-0" />
...
//                     </span>
//                   </h2>
//                   <div className="w-20 h-1 bg-gradient-to-r from-purple-500 via-pink-500 to-blue-500 rounded-full mx-auto" />
//                 </div>
...
//                       className="bg-white/80 backdrop-blur-2xl rounded-2xl p-6 shadow-xl border border-white/60 hover:border-indigo-200 transition-all duration-300"
//                     >
//                       <div className="flex flex-col items-center text-center space-y-4">
//                         <div className="relative">
//                           <div className="w-16 h-16 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 p-0.5 shadow-xl">
//                             <Image
//                               src={
...
//                               <div
//                                 key={subjectIndex}
//                                 className="bg-gradient-to-r from-purple-100 to-pink-100 text-purple-700 px-2 py-1 rounded-lg text-xs font-medium border border-purple-200"
//                               >
//                                 {subject}
//                               </div>
//                             ))}
...
//                       }
//                     >
//                       <Card className="bg-white/80 backdrop-blur-2xl border border-white/60 rounded-2xl shadow-xl hover:shadow-2xl transition-all duration-300 hover:border-indigo-200">
...
//                               <div className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-3 py-1 rounded-xl text-xs font-bold shadow-lg">
