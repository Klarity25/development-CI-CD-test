...
//               </div>
//               <div className="bg-white/70 backdrop-blur-sm rounded-2xl p-6 text-center border border-white/20 shadow-lg">
//                 <div className="text-2xl font-bold text-amber-600">{noRole.length}</div>
//                 <div className="text-sm text-gray-600 font-medium">Unassigned</div>
//               </div>
//             </motion.div>
...
//                           {u.employeeId && (
//                             <div
//                               className={`absolute top-3 right-3 px-2 py-1 rounded-lg text-xs font-semibold text-white ${getBadgeStyles(u.role?.roleName || "")} shadow-lg`}
//                             >
...
//                                   {u.name}
//                                 </h3>
//                                 <Badge className={`${getRoleBadgeStyles(u.role?.roleName || "")} text-xs mt-1`}>
//                                   {u.role?.roleName}
//                                 </Badge>
//                               </div>
//                             </div>
...
//                   </div>
//                   <h2 className="text-2xl font-bold text-gray-900">Unassigned Users</h2>
...
//                                   {u.name}
//                                 </h3>
//                                 <Badge className={`${getRoleBadgeStyles("")} text-xs mt-1`}>Not Assigned</Badge>
//                               </div>
//                             </div>
...
//                                 onClick={(e) => {
//                                   e.stopPropagation()
//                                   router.push(`/admin/assign-role?userId=${u._id}`)
//                                 }}
//                               >
//                                 Assign Role
//                               </Button>
                  ...
                  <AnimatePresence>
                    {students.map((u, index) => (
                      ...
                      >
                        <Card className="relative bg-white border-0 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 overflow-hidden group">
                          <div
                            className="absolute inset-0 bg-gradient-to-r from-green-500/5 to-emerald-500/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300"
                            onClick={() => handleCardClick(u._id)}
                          ></div>
